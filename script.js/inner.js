...
'<div class="menu">'+
'<nav>'+
'<a href="index.html"  style="animation-delay: 0.2s;">Inicio</a>'+
'<a href="quienessomos.html"  style="animation-delay: 0.3s;">Quienes somos?</a>'+
'<a href="huerta.html"  style="animation-delay: 0.4s;">Huerta</a>'+
'<a href="tienda.html"  style="animation-delay: 0.5s;">Tienda</a>'+
'<a href="#scrollpycontacto" style="animation-delay: 0.6s;">Contacto</a>'+
'</nav>'+
'</div>'+
