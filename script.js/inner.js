...
'          <a class="nav-link dropdown-toggle active" href="huerta.html" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Huerta</a>'+
'          <ul class="dropdown-menu">'+
'            <li><a class="dropdown-item" href="#">Tipos de huertas</a></li>'+
'            <li><a class="dropdown-item" href="#">Calendario de siembra</a></li>'+
